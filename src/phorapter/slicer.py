...
from phorapter.errors import SlicingError
from phorapter.grid import DEFAULT_GRID, GridSpec
from phorapter.model import Slice, SlicedDocument
...
def multi_view_slice(
    ...
    *,
    ...
    Returns a :class:`~phorapter.model.SlicedDocument` whose ``slices`` are in

...
5. runs the selection strategy and returns its :class:`~phorapter.selection.Selection`
...
if TYPE_CHECKING:
    ...
    from phorapter.selection import SliceSource
    from phorapter.service.core import ServiceCore
    from phorapter.stores import CorpusConfig
...
class QueryService:
    ...
    async def _prefetch_ancestors(
        ...
        from phorapter.service.core import PrefetchSource

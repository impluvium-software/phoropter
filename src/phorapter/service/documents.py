...
from phorapter.stores import DocumentRecord, SlicePoint
...
if TYPE_CHECKING:
    ...
    from phorapter.stores import DocumentPage

__all__ = ["DocumentService", "DocumentTooLargeError"]


class DocumentTooLargeError(PhorapterError):
...
class DocumentService:
    ...
    async def put(
        ...
        *,
        ...
        Raises :class:`~phorapter.errors.DocumentTooLargeError` (HTTP 413) when
        the text exceeds ``limits.max_document_codepoints``, and
        :class:`~phorapter.errors.SlicingError` (HTTP 422) when the text cannot

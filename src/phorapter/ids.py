...
__all__ = ["PHORAPTER_NAMESPACE", "slice_name", "slice_uuid"]

PHORAPTER_NAMESPACE = uuid.UUID("d90d882b-2065-5bad-a28e-6c0d117fcfb3")
"""The project's UUIDv5 namespace.

Derived once as ``uuid5(NAMESPACE_DNS, "phorapter.impluvium.software")`` and
...
def slice_uuid(
    ...
    *,
    ...
    return uuid.uuid5(
        PHORAPTER_NAMESPACE, slice_name(document_id, size, codepoint_offset, corpus=corpus)
    )
